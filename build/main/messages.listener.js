...
const message_command_mapper_1 = __importDefault(
  require("./message-command.mapper"),
);
const messageListener = (client) =>
          ...
          if (
            (_a =
              Object === null || Object === void 0
                ? void 0
                : Object.keys(message_command_mapper_1.default)) === null ||
            _a === void 0
              ? void 0
              : _a.includes(command)
          ) {
            const action =
              message_command_mapper_1.default === null ||
              message_command_mapper_1.default === void 0
                ? void 0
                : message_command_mapper_1.default[command];
